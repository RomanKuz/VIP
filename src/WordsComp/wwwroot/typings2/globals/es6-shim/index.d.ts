...
interface ES6Promise <T> {
    ...
    * @returns A Promise for the completion of which ever callback is executed.
    */
    then<TResult>(onfulfilled?: (value: T) => TResult | PromiseLike<TResult>, onrejected?: (reason: any) => TResult | PromiseLike<TResult>): ES6Promise <TResult>;
    then<TResult>(onfulfilled?: (value: T) => TResult | PromiseLike<TResult>, onrejected?: (reason: any) => void): ES6Promise <TResult>;
     ...
     */
    catch(onrejected?: (reason: any) => T | PromiseLike<T>): ES6Promise <T>;
    catch(onrejected?: (reason: any) => void): ES6Promise <T>;
}
...
interface PromiseConstructor {
     ...
     */
    new <T>(executor: (resolve: (value?: T | PromiseLike<T>) => void, reject: (reason?: any) => void) => void): ES6Promise <T>;
     ...
     */
    all<T>(values: IterableShim<T | PromiseLike<T>>): ES6Promise <T[]>;
     ...
     * @returns A new Promise.
     */
    race<T>(values: IterableShim<T | PromiseLike<T>>): ES6Promise <T>;
     ...
     */
    reject(reason: any): ES6Promise <void>;
     ...
     * @returns A new rejected Promise.
     */
    reject<T>(reason: any): ES6Promise <T>;
    ...
    /**
      ...
      */
    resolve<T>(value: T | PromiseLike<T>): ES6Promise <T>;

    /**
     * Creates a new resolved promise .
     * @returns A resolved promise.
     */
    resolve(): ES6Promise <void>;
}
